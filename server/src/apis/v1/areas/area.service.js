...
class AreaService extends DBModel {
  table = "areas";
  primaryKey = "id";
  ...
  async create(data) {
    try {
      ...
      console.log(`[AreaService -- error create]:::`, error);
  ...
  async update(id, data) {
    try {
      ...
      console.log(`[AreaService -- error update]:::`, error);
      return Promise.reject(error);
    }
  }
  ...
  async getAll(filters) {
    try {
      ...
      console.log(`[AreaService -- error find]:::`, error);
      return Promise.reject(error);
    }
  }
  ...
  async getById(id) {
    try {
      ...
      console.log(`[AreaService -- error getById]:::`, error);
      return Promise.reject(error);
    }
  }
}
