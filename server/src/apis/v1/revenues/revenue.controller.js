...
class RevenueController {
  ...
  getRevenueByTrips = async (req, res, next) => {
    try {
      const response = await RevenueService.countTrips(req.user);
  ...
  getRevenueByCustomers = async (req, res, next) => {
    try {
      const response = await RevenueService.countCustomer(req.user);
