  ...
  return (
    <Grid item xs={12} md={9}>
      <Typography variant="h4">
        {`${destination}: tìm thấy ${data?.length || 0} chỗ nghỉ`}
      </Typography>
            ...
            <div key={index}>
              <Stack width="100%" my="16px">
                ...
                >
                  ...
                  <Box flex={2}>
                    <Stack justifyContent="space-between" direction={{ md: "row", xs: "column" }}>
                      <Typography
                        sx={{
                      ...
                      >
                        <Typography fontWeight={700} lineHeight="24px">
                          {+item.hotel_rating === 0 ? "Chưa có đánh giá" : "Xuất sắc"}
                        </Typography>
                        <Box
                          sx={{
                            background: "#003580",
                    ...
                    >
                      <Typography fontSize={12}>Ưu Đãi Trong Thời Gian Có Hạn</Typography>
                    </Box>
                    ...
                    >
                      <Box>
                        <Typography textTransform="capitalize" fontSize={12} fontWeight={700}>
                          Căn hộ nhìn ra vườn
                        </Typography>
                      ...
                      <Box textAlign={{ md: "right", xs: "left" }} minWidth={150}>
                        {item.discount === 1 && (
                          <Typography
                            color="#c00"
                            fontSize={12}
                        ...
                        <Typography fontSize={20} fontWeight={700} mt="5px">
                          {item.discount === 1
                            ...
                            : fPrice(
                                calcPriceAndTax({
                                  price: +item.price * resultCountDate,
                                  tax: item.tax,
                                })
                              )}
                        </Typography>

                        <Typography fontSize={11} fontWeight={300} color="gray" mt="5px">
                          Đã bao gồm <strong>{`${item.tax}%`}</strong> thuế và phí
                        </Typography>
